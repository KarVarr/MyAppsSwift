...
enum Helpers {
    ...
    enum Strings {
        ...
        static let settingsAboutText = " ❝ Experience TerraScape, the ultimate productivity tool for staying focused and relaxed. Immerse yourself in a variety of ambient sounds, from gentle rain to the cozy warmth of a crackling fire. TerraScape works like magic, enhancing productivity while creating a serene environment. Tune out distractions with soothing rain sounds! ❞ "
