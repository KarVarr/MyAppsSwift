...
extension Letter {
    static let allLetters: [Letter] = [
        ...
        Letter(character: "Ը", englishTranslation: "ə", russianTranslation: "ы – э", animals: ["Ընձուղտ", "Ընկույզ", "Ընտանիք"]),
        ...
        Letter(character: "Պ", englishTranslation: "p", russianTranslation: "п", animals: ["Պատառաքաղ", "Պանիр", "Պատ", "Պատուհան"]),
