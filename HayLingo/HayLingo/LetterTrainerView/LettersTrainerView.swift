...
struct LettersTrainerView: View {
    ...
    let animals: [String: [String]] = [
        "Ա": ["Աստղ", "Առյուծ", "Արագիլ", "Արջ", "Ամպեր", "Արև"],
        ...
        "Թ": ["Թռչուն - птица", "Թուղթ - бумага", "Թագ - корона", "Թամбур - бубен"],
        "Ժ": ["Ժրաջան - морж", "Ժամացույց - часы", "Ժողով - собрание", "Ժանգոտ - ржавый"],
        "Ի": ["Իգուана - игуана", "Իրիկա - вечер", "Իսկ - игра", "Ինքնաթիռ - самолет"],
        "Լ": ["Լամпа - лампа", "Լիճ - озеро", "Լուսատու - светильник", "Լեռ - гора"],
        "Խ": ["Խոզ - свинья", "Խատուտիկ - одуванчик", "Խեղդել - замок", "Խեցգետին - рак"],
        "Ծ": ["Ծով - море", "Ծաղիկ - цветок", "Ծովախոզ - кит", "Ծիծաղ - смех"],
        "Կ": ["Կատու - кот", "Կոմպьютեր - компьютер", "Կառուսель - карусель", "Կեռաս - вишня"],
        "Հ": ["Հավ - курица", "Հաց - хлеб", "Հովանոց - зонт", "Հեքիաթ - сказка"],
        "Ձ": ["Ձուկ - рыба", "Ձմեռ - зима", "Ձիթենիձ - оливковое дерево", "Ձայներ - звуки"],
        "Ղ": ["Ղազար - газель", "Ղուլ - гигант", "Ղամազ - гамма", "Ղեկ - руль"],
        "Ճ": ["Ճանապարհ - дорога", "Ճպուռ - кузнечик", "Ճանճ - муха", "Ճամպրուկ - чемодан"],
